...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 23, 2023 at 02:12 PM
...
('root', '[{\"db\":\"practice\",\"table\":\"students\"},{\"db\":\"practice\",\"table\":\"stud_unique\"},{\"db\":\"practice\",\"table\":\"studef\"},{\"db\":\"logindb\",\"table\":\"user\"},{\"db\":\"testsite\",\"table\":\"users\"}]');
...
('root', '2023-06-23 12:09:51', '{\"Console\\/Mode\":\"collapse\",\"NavigationWidth\":0}');
...
-- Database: `testsite`
--
CREATE DATABASE IF NOT EXISTS `testsite` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `testsite`;
